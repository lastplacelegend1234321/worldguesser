                ...
                <div className={styles.playerInfo}>
                  ...
                  {displayName && (
                    <span className={styles.playerSummary}>
                      {`${displayName}'s ProGuessr.com ${useElo ? 'ELO' : 'XP'} score`}
                    </span>
                  )}
...
Leaderboard.seo = {
  title: "ProGuessr.com Leaderboard | Top Players & Rankings",
  description: "Track the best ProGuessr.com players by ELO or XP and compare your score against the global community.",
};
